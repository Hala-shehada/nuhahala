...
import 'package:flutter_application_1/realDetails/realF_details.dart';
...
class Farm1 extends StatefulWidget {
  ...
  var selectedCounrty;
  Farm1({Key? key, required this.firstlist, required this.selectedCounrty})
      : super(key: key);

  @override
  State<Farm1> createState() => _Farm1State();
}
...
class NewPostItem4 extends StatefulWidget {
  final rating;
  ...
  _NewPostItem4State createState() => _NewPostItem4State();
}

class _NewPostItem4State extends State<NewPostItem4> {
  String? myImageName;
  String? phoneNo;
  String? myName;
