...
import 'package:flutter_application_1/realDetails/realL_details.dart';
...
import 'package:flutter_application_1/real_data.dart';
...
class Land1 extends StatefulWidget {

  final List firstlist;
 

  var selectedCounrty;
  Land1({Key? key, required this.firstlist,required this.selectedCounrty}) : super(key: key);

 @override
  State<Land1> createState() => _Land1State();

}



class _Land1State extends State<Land1> {
...
class NewPostItem3 extends StatefulWidget {
  final rating;
  ...
  _NewPostItem3State createState() => _NewPostItem3State();
}

class _NewPostItem3State extends State<NewPostItem3> {
  String? myImageName;
  String? phoneNo;
  String? myName;
