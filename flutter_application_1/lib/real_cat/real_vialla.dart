...
import 'package:flutter_application_1/hfirst_screen.dart';
...
class Villa1 extends StatefulWidget {
  final List firstlist;

  var selectedCounrty;
  Villa1({Key? key, required this.firstlist, required this.selectedCounrty})
      : super(key: key);

  @override
  State<Villa1> createState() => _Villa1State();
}

class _Villa1State extends State<Villa1> {
  ...
  Future showAllPost() async {
    var url = Uri.parse("http://192.168.1.100/gradpro/allPost.php");
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: ((context, index) {
                            return NewPostItem(
                              ...
                              beadroom: postData[index]['bedroom'],
                              bathroom: postData[index]['bathroom'],
                              hall: postData[index]['hall'],
                              real_name: postData[index]['real_name'],
                              city: postData[index]['city'],
                              user_id: postData[index]['user_id'],
                              image:
                                  'http://192.168.1.100/gradpro/img/${postData[index]['image']}',
...
class _NewPostItemState extends State<NewPostItem> {
  ...
  Future getData() async {
    var url = Uri.parse('http://192.168.1.100/gradpro/getdata.php');
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) => DetailV(
                                  ...
                                  map2: widget.map2,
                                  img:
                                      'http://192.168.1.100/gradpro/images/$myImageName',
                                  name: myName,
                                  phone: phoneNo,
