...
import 'package:flutter_application_1/realDetails/realA_details.dart';
...
class Apart extends StatefulWidget {
  final List firstlist;

 
  var selectedCounrty;
  Apart({Key? key, required this.firstlist, required this.selectedCounrty})
      : super(key: key);

  @override
  State<Apart> createState() => _ApartState();
}

class _ApartState extends State<Apart> {
...
class NewPostItem5 extends StatefulWidget {
  final rating;
  ...
  _NewPostItem5State createState() => _NewPostItem5State();
}

class _NewPostItem5State extends State<NewPostItem5> {
  String? myImageName;
  String? phoneNo;
  String? myName;
