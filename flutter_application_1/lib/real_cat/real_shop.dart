...
import '../../pallete.dart';
import '../realDetails/realS_details.dart';
...
class Shop1 extends StatefulWidget {
  ...
  var selectedCounrty;
  Shop1({Key? key, required this.firstlist, required this.selectedCounrty})
      : super(key: key);
...
class NewPostItem1 extends StatefulWidget {
  final rating;
  ...
  const NewPostItem1({
    ...
    this.cat_type1,
    this.post_id1,
    this.total_comments, this.rating,
  }) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _NewPostItem1State createState() => _NewPostItem1State();
}

class _NewPostItem1State extends State<NewPostItem1> {
  String? myImageName;
  String? phoneNo;
  String? myName;
