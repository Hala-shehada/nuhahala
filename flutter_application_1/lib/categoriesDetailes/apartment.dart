...
class _ApartmentState extends State<Apartment> {
  ...
  void initState() {
    super.initState();
// log(widget.position[0]);
// log(widget.position[1]);
    selectedRadioTile = 0;
  }
    ...
    if (images != null) {
      for (var i = 0; i < images.length; i++) {
        ...
        FormData formData = FormData.fromMap({
          ...
          "real_name": textfieldsStrings2[6],
          "price": textfieldsStrings2[0],
          "map1": widget.position[0],
          "map2": widget.position[1],
          "rent_sale": textfieldsStrings2[7],
          "space": textfieldsStrings2[3],
          'location': textfieldsStrings2[4],
          'level': textfieldsStrings2[2]
        });
        var response = await dio.post(
            'http://192.168.1.104/gradpro/apartment_post.php',
            data: formData);
