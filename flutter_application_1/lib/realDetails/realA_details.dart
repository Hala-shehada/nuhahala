...
Future myComments() async {
    ...
    var url = Uri.parse('http://192.168.1.104/gradpro/likedApartment.php');
 ...
 Future getLikes() async {
   ...
   Future addLike() async {
    var url = Uri.parse('http://192.168.1.104/gradpro/addLikesApartment.php');
    var response = await http.post(url, body: {
      "user_id": widget.login_id,
      "post_id": widget.post_id,
      "cat_type": widget.cat_type,
...
Future addComments() async {
    var url = Uri.parse('http://192.168.1.104/gradpro/addApartmentComments.php');
    var response = await http.post(url, body: {
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          buildFeature(Icons.apartment,"level No. ${widget.level}" ),
