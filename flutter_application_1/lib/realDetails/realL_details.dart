...
class _DetailLState extends State<DetailL> {
  ...
  Future addLike() async {
    var url = Uri.parse('http://192.168.1.104/gradpro/addLikesLand.php');
    var response = await http.post(url, body: {
      "user_id": widget.login_id,
      "post_id": widget.post_id,
      "cat_type": widget.cat_type,
  ...
  Future addComments() async {
    var url = Uri.parse('http://192.168.1.104/gradpro/addLandComments.php');
    var response = await http.post(url, body: {
                        ...
                        children: [
                          RatingBar.builder(
                            ...
                            onRatingUpdate: (rating) => setState(() {
                              ...
                              // widget.property.review = rating.toString();
